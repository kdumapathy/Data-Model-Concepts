...
export const processStarSchema = `erDiagram
    %% PROCESS STAR SCHEMA with SAP GBT Genealogy
    ...
    MATERIAL ||--o| MATERIAL : "parent_material (lineage)"
    LOCAL_PROCESS_HIERARCHY ||--o| LOCAL_PROCESS_HIERARCHY : "parent_step (decomposition)"
    COMMON_PROCESS_HIERARCHY ||--o| COMMON_PROCESS_HIERARCHY : "parent_process (taxonomy)"
...
export const processStarSchema_metadata = {
    title: "Process Star Schema",
    id: "processstarschema"
};
