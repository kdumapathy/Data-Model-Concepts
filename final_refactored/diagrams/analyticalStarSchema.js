...
export const analyticalStarSchema = `erDiagram
    %% ANALYTICAL STAR SCHEMA with SAP GBT Genealogy
...
export const analyticalStarSchema_metadata = {
    title: "Analytical Star Schema",
    id: "analyticalstarschema"
};
